...
/*
Tworzymy aplikację dla automatu, w którym można kupić gry komputerowe. Automat przechowuje kilka najnowszych tytułów. Każda gra opisana jest za pomocą nazwy i ceny.
...
public class Game {
    ...
    public Game(String name, int prize) {
        this.name = name;
        this.prize = prize;
    }
